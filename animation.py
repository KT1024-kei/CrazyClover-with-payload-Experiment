...
class pl():
    def __init__(self,ax = None):
        ...
        self.pos_history = deque(maxlen=1)
...
drone_nom = pd.read_csv('~/crazyswarm/ros_ws/src/crazyswarm/Exp_Payload/drone_nom.csv')
drone_state = pd.read_csv('~/crazyswarm/ros_ws/src/crazyswarm/Exp_Payload/drone_state.csv')
load_nom = pd.read_csv('~/crazyswarm/ros_ws/src/crazyswarm/Exp_Payload/load_nom.csv')
load_state = pd.read_csv('~/crazyswarm/ros_ws/src/crazyswarm/Exp_Payload/load_state.csv')
